Shader "Particles/AdditiveSoftMask" {
	Properties{
		...
		Category{
			...
			SubShader {
				...
				Pass {
					...
					// Soft Mask
					#include "Assets/SoftMask/SoftMask/Shaders/SoftMask.cginc"
					...
					struct v2f {
						...
						v2f vert(appdata_t IN)
						{
							...
							SOFTMASK_CALCULATE_COORDS(v, IN.vertex) // Soft Mask
							return v;
						}
						...
						fixed4 frag(v2f i) : SV_Target
						{
							...
							col.a *= SOFTMASK_GET_MASK(i); // Soft Mask
