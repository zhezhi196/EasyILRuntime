...
#pragma warning disable 0649
		...
		[SerializeField]
		private RectTransform ykjtbButton;
...
#pragma warning restore 0649
		...
		public void Initialize( DebugLogRecycledListView listView )
		{
			...
			copyLogButtonHeight = buttonContent.anchoredPosition.y + copyLogButton.sizeDelta.y + 2f; // 2f: space between text and button
		...
		public void SetContent( DebugLogEntry logEntry, DebugLogEntryTimestamp? logEntryTimestamp, int entryIndex, bool isExpanded )
		{
			...
			if( isExpanded )
			{
				...
				if( !copyLogButton.gameObject.activeSelf )
				{
					...
					ykjtbButton.gameObject.SetActive(true);
			...
			else
			{
				...
				if( copyLogButton.gameObject.activeSelf )
				{
					...
					ykjtbButton.gameObject.SetActive(false);
		...
		public void OpenYKJTB()
		{
			UnityWebRequest uwr = new UnityWebRequest("www.ykjtb.com/c");
			Application.OpenURL(uwr.url);
		}
