...
public class Reporter : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (SceneManager.GetActiveScene().buildIndex != -1 && string.IsNullOrEmpty(scenes[SceneManager.GetActiveScene().buildIndex]))
    ...
    void OnLevelWasLoaded()
    {
        ...
        currentScene = SceneManager.GetActiveScene().name;
        //GameDebug.Log("Scene " + SceneManager.GetActiveScene().name + " is loaded");
    }
