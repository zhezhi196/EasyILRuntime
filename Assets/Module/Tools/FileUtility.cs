...
namespace Module
{
    public class FileUtility
    {
        ...
        public static bool SafeWriteAllText(string outFile, string text)
        {
            ...
            {
                GameDebug.LogError(string.Format("SafeWriteAllText failed! path = {0} with err = {1}", outFile,
                    ex.Message));
                return false;
            }
        }
        ...
        public static byte[] SafeReadAllBytes(string inFile)
        {
            ...
            {
                GameDebug.LogError(string.Format("SafeReadAllBytes failed! path = {0} with err = {1}", inFile, ex.Message));
                return null;
            }
        }
        ...
        public static string[] SafeReadAllLines(string inFile)
        {
            ...
            {
                GameDebug.LogError(string.Format("SafeReadAllLines failed! path = {0} with err = {1}", inFile, ex.Message));
                return null;
            }
        }
        ...
        public static string SafeReadAllText(string inFile)
        {
            ...
            {
                GameDebug.LogError(string.Format("SafeReadAllText failed! path = {0} with err = {1}", inFile, ex.Message));
                return null;
            }
        }
        ...
        public static bool SafeClearDir(string folderPath)
        {
            ...
            {
                GameDebug.LogError(string.Format("SafeClearDir failed! path = {0} with err = {1}", folderPath, ex.Message));
                return false;
            }
        }
        ...
        public static bool SafeDeleteDir(string folderPath)
        {
            ...
            {
                GameDebug.LogError(string.Format("SafeDeleteDir failed! path = {0} with err: {1}", folderPath, ex.Message));
                return false;
            }
        }
        ...
        public static bool SafeDeleteFile(string filePath)
        {
            ...
            {
                GameDebug.LogError(string.Format("SafeDeleteFile failed! path = {0} with err: {1}", filePath, ex.Message));
                return false;
            }
        }
        ...
        public static bool SafeRenameFile(string sourceFileName, string destFileName)
        {
            ...
            {
                GameDebug.LogError(string.Format("SafeRenameFile failed! path = {0} with err: {1}", sourceFileName,
                    ex.Message));
                return false;
            }
        }
        ...
        public static bool SafeCopyFile(string fromFile, string toFile)
        {
            ...
            {
                GameDebug.LogError(string.Format("SafeCopyFile failed! formFile = {0}, toFile = {1}, with err = {2}",
        ...
        public static void CopyDirectory(string sourceDirectory, string targetDirectory)
        {
            try
            {
                ...
                {
                    string filePathTemp = FormatToUnityPath(targetDirectory + "\\" + i.Name);
                    if (i is DirectoryInfo)
                    {
                        ...
                        CopyDirectory(i.FullName, filePathTemp);
                    }
                    else
                    {
                        File.Copy(i.FullName, filePathTemp, true);
                    }
                }
            }
            catch (Exception ex)
            {
                GameDebug.LogError("Copy Error:" + ex.Message);
            }
        }
    }
}