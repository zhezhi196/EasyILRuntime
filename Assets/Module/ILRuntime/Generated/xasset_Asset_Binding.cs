...
{
    unsafe class xasset_Asset_Binding
    {
        ...
        static StackObject* get_asset_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            xasset.Asset instance_of_this_method = (xasset.Asset)typeof(xasset.Asset).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
