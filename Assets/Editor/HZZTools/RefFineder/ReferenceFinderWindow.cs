...
public class ReferenceFinderWindow: EditorWindow
{
    ...
    private bool needUpdateAssetTree;

    private bool initializedGUIStyle;
    ...
    public void DrawOptionBar()
    {
        ...
        if (GUILayout.Button("Help", toolbarButtonGUIStyle))
        {
            Application.OpenURL("https://github.com/blueberryzzz/ReferenceFinder");
        }
