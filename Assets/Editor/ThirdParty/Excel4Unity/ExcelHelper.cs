...
public class ExcelHelper
{
    ...
    public static Excel LoadExcel(string path,bool importRichText=false)
    {
        FileInfo file = new FileInfo(path);
        ExcelPackage ep = new ExcelPackage(file);
        Excel xls = new Excel(ep.Workbook,importRichText);
        return xls;
    }

	public static Excel CreateExcel(string path,bool importRichText=false) {
