...
{
    [CustomEditor(typeof(PropsCreator),true)]
    public class PropsCreatorEditor: OdinEditor
    {
        private FieldInfo[] field;
        private object[] fieldStr;
        protected BoxBoundsHandle m_BoundsHandle = new BoxBoundsHandle();
        public PropsCreator trigger;
        protected override void OnEnable()
        {
            trigger = (PropsCreator)target;
            ...
            if (trigger.staticLoad && trigger.props == null)
            {
                trigger.staticLoad = false;
            }
