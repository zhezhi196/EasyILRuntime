...
namespace SqlCipher4Unity3D
{
	...
	public partial class SQLiteConnection : IDisposable
	{
		...
		public SQLiteConnection(string databasePath, SQLiteOpenFlags flag,string password = null, bool storeDateTimeAsTicks = true)
			: this(new SQLiteConnectionString(databasePath, flag, storeDateTimeAsTicks, password))
		{
		}
