...
namespace Module
{
    ...
    public class ZlibHelper
    {
        ...
        /// </summary>
        /// <param id="OrgByte">需要被压缩的原始Byte数组数据</param>
        /// <param id="CompressRate">压缩率：默认为zlibConst.Z_DEFAULT_COMPRESSION</param>
        ...
        /// </summary>
        /// <param id="CompressedBytes">被压缩的Byte数组数据</param>
        ...
        /// 压缩字符串
        /// </summary>
        /// <param id="SourceString">需要被压缩的字符串</param>
        ...
        /// 解压字符串
        /// </summary>
        /// <param id="SourceString">需要被解压的字符串</param>
