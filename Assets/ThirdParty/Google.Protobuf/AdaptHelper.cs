...
public static class AdaptHelper
{
    public static IMethod GetMethod(this ILType type, AdaptMethod m)
    {
        ...
        if (m.Method == null)
        {
            ...
            throw new Exception($"can't find the method:{m.Name},paramCount:{m.ParamCount},type:{type.FullName},baseClass:{baseClass}");
        }
...
public abstract class MyAdaptor : CrossBindingAdaptorType
{
    ...
    private AdaptMethod[] _methods;

    protected abstract AdaptMethod[] GetAdaptMethods();
