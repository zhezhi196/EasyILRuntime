...
public class MainProcedure: BattleProcedure
{
    public MainProcedure(Mission mission,Action callback) : base(mission,callback)
    {
    ...
    protected override void SortAction()
    {
        ...
        AddAction(BattleController.GetCtrl<PostPlayerData>().postPlayerData);
